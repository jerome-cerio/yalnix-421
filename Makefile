...
#
ALL = yalnix samples-lab2/forktestinfinite
...
#
KERNEL_OBJS = yalnix.o arguments.o interrupthandlers.o memorymanagement.o processes.o queues.o systemcalls.o
KERNEL_SRCS = yalnix.c arguments.c interrupthandlers.c memorymanagement.c processes.c queues.c systemcalls.c
